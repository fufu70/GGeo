...
class GGeoAddress
{
	...
	/**
	 * Returns the administrative area level 1 name normalized by the Google Maps web service
	 * @return string $administrative_area_level_1
	 */
	...
	/**
	 * Returns the administrative area level 2 name normalized by the Google Maps web service
	 * @return string $administrative_area_level_2
	 */
